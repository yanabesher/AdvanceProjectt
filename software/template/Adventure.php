...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="Adventure.php" method="post" class="navbar-form navbar-left">
    ...
    <!-- MAIN -->
    <div class="main">
        <form id="DEL" action="Adventure.php" method="post" enctype="multipart/form-data">
            ...
            <a href="Adventure.php#popup" target="_self" style="border: orange"  >
                <img width="100" height="50" border="0" align="center"  src="assets/img/add1.png" ><br>

            </a>
            <a href="Adventure.php#popup1" target="_self" style="border: orange"  >
                ...
                try {
                    ...
                    if (isset($_POST['go'])) {
                        ...
                        <table border="1px">
                            ...
                            <?php
                            $sql = "select * from games where `Genre`='Adventure' and $column like '%$search%' " ;
                        ...
                        $result = $db->query("SELECT * FROM games WHERE `Genre`='Adventure'  ");
