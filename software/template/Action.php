...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="Action.php" method="post" class="navbar-form navbar-left">
    ...
    <!-- MAIN -->
    <div class="main">
        <form id="DEL" action="Action.php" method="post" enctype="multipart/form-data">
            ...
            <a href="Action.php#popup" target="_self" style="border: orange"  >
                <img width="100" height="50" border="0" align="center"  src="assets/img/add1.png" ><br>

            </a>
            <a href="Action.php#popup1" target="_self" style="border: orange"  >
        ...
        <form   id="popup" method="post">
            <div class="popup-content">
                ...
                <form id="login" class="input-group" action="Action.php" method="post">
...
<table border="1px">
    ...
    <?php
    $sql = "select * from games where `Genre`='Action' and $column like '%$search%' " ;
        ...
        while($row = $result->fetch_assoc() ){
            ?>
                ...
                <?php
                            ...
                            $result = $db->query("SELECT * FROM games WHERE `Genre`='Action'  ");
