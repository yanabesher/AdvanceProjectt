    ...
    <div class="container">
        ...
        <div class="filtr-container w3layouts agileits">
            ...
            while($DUP<84){
                ...
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Action' and Rank=$DUP");
           ...
           // $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<119){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Sports' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
         ...
         //   $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<91){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Puzzle' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
          ...
          //  $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<206){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Strategy' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
          ...
          //  $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<44){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Racing' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="5" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
          ...
          //  $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<419){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Adventure' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="6" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
           ...
           // $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<107){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Fighting' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="7" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
          ...
          //  $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<89){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Platform' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="8" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
           ...
           // $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<87){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Shooter' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="9" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
          ...
          //  $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<114){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Misc' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="10" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
          ...
          //  $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<85){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Simulation' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="11" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
       ...
       //     $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<87){?>
                ...
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="12" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
           ...
           // $conn = mysqli_connect("localhost", "root", "", "advance");
            ...
            while($DUP<22){?>
                <?php
                $image_details  = mysqli_query($conn, "SELECT * FROM games  where Genre ='Role-Playing' and Rank=$DUP");
                $row = mysqli_fetch_array($image_details);
                if($row != null){
                    ?>
                    <div class=" filtr-item w3layouts agileits portfolio-t" data-category="13" data-sort="Busy streets">
                        <a href="Games.php" target="_blank" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
                            <?php
                            $filename= "images_game/".$row['Name'].".jpg";
                            if(file_exists($filename)){
