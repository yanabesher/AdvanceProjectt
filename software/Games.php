...
if (isset($_POST['add'])){
    ...
    $em=$_SESSION['E'];
    $r=$_POST['Rank'];
    $n=$_POST['CartProdName'];
    $p=$_POST['CartProdPrice'];

    $c="cart";
    $strQry = "INSERT INTO wishlist values ('".$em."','".$r."','".$n."','".$p."','".$c."')";
    $res = $dp->query($strQry);
                        ...
                        <div class="navbar navbar-expand-lg  " >
                            <nav>
                                <ul class=" navbar-nav">
                                    ...
                                    <li ><a href="wishlist page.php" class="Button" >Wishlist</a></li>
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class="filtr-item w3layouts agileits portfolio-t" data-category="1" data-sort="Busy streets" style="padding: 5px ; width: 25%">
                        ...
                        if(file_exists($nimage)){
                            ...
                            $pppp= $row['NA_Sales'];
                            $rrrr=$row['Rank'];
                            component($row['Name'], $row['NA_Sales'], $nimage, $row['Rank'],$row['Platform'],$row['Rank']);
                        }
...
Security
Insights
AdvanceProjectt/software/Games.php /
@EntimaaBushkar
EntimaaBushkar Home/Games/cart
Latest commit 092abd4 yesterday
History
1 contributor
742 lines (605 sloc)  29 KB
