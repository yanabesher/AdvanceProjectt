...
<div id="wrapper">
    ...
    <!-- MAIN -->
    <div class="main">
        <form id="DEL" action="Fighting.php"  method="post" enctype="multipart/form-data">
            ...
            <a   href="Fighting.php#popup"  target="_self" style="border: orange"  >
                <img width="100" height="50" border="0" align="center"  src="assets/img/add1.png" ><br>

            </a>
            <a   href="Fighting.php#popup1"  target="_self" style="border: orange"  >
