...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="Shooter.php" method="post" class="navbar-form navbar-left">
    ...
    <!-- MAIN -->
    <div class="main">
        <form id="DEL" action="Shooter.php"  method="post" enctype="multipart/form-data">
            ...
            <a   href="Shooter.php#popup"  target="_self" style="border: orange"  >
                <img width="100" height="50" border="0" align="center"  src="assets/img/add1.png" ><br>

            </a>
            <a   href="Shooter.php#popup1"  target="_self" style="border: orange"  >
                ...
                try {
                    ...
                    if (isset($_POST['go'])) {
                        ...
                        <table border="1px">
                            ...
                            <?php
                            $sql = "select * from games where `Genre`='Shooter' and $column like '%$search%' " ;
                        ...
                        $result = $db->query("SELECT * FROM games WHERE `Genre`='Shooter'  ");
