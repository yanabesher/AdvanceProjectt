...
if (isset($_POST['ad'])  && isset($_POST['id1']) && isset($_POST['id2']) && isset($_POST['id3'])&& isset($_POST['id4'])&& isset($_POST['id6'])&& isset($_POST['id7'])
    ...
    $id2 = $_POST['id2'];
    $id3= $_POST['id3'];
    $id4 = $_POST['id4'];$id5= 'Role-Playing';
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="role.php" method="post" class="navbar-form navbar-left">
    ...
    <!-- MAIN -->
    <div class="main">
        <form id="DEL" action="role.php"  method="post" enctype="multipart/form-data">
            ...
            <a   href="role.php#popup"  target="_self" style="border: orange"  >
                <img width="100" height="50" border="0" align="center"  src="assets/img/add1.png" ><br>

            </a>
            <a   href="role.php#popup1"  target="_self" style="border: orange"  >
                ...
                try {
                    ...
                    if (isset($_POST['go'])) {
                        ...
                        <table border="1px">
                            ...
                            <?php
                            $sql = "select * from games where `Genre`='Role-Playing' and $column like '%$search%' " ;
                        ...
                        $result = $db->query("SELECT * FROM games WHERE `Genre`='Role-Playing'  ");
